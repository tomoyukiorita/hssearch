...
export const deepResearch = new FunctionTool({
  name: 'deep_research',
...
この情報は後のHSコード検索で使用します。`,
  parameters: z.object({
    productName: z.string().describe('調査する商品名'),
    maker: z.string().optional().describe('メーカー名（オプション）'),
    additionalContext: z.string().optional().describe('追加のコンテキスト情報'),
  }),
